  ...
  return (
    <div className="w-screen h-screen bg-gray-900 flex flex-col items-center justify-center text-gray-100">
      <header className="flex flex-col items-center">
        ...
        <Text size="lg" className="text-gray-400 mt-1">Make login and start using!</Text>
      </header>
      ...
      <form className="flex flex-col gap-4 items-stretch w-full max-w-[400px] mt-10">
        <label htmlFor="email" className="flex flex-col gap-3">
          ...
          <TextInput.Root>
            ...
            <TextInput.Input type="email" id="email" placeholder='Type your email address here'/>
          </TextInput.Root>
        </label>
        ...
        <Button type="submit" className='mt-4'>Access My Account</Button>
      </form>
